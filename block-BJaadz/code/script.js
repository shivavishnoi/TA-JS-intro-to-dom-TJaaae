...
/*
Convert the NodeList returned by querySelectorAll to Array using Array.from() or spread operator and store it in allHrsArra
...
document.querySelector(`.two`).append(para1)
...
document.querySelector(`.three`).prepend(para3)
...
let all = Array.from(document.querySelectorAll(`.box`))
...
document.querySelector(`.six`).setAttribute(`class`, `awesome-box`)
...
imgElm.src = `https://images.unsplash.com/photo-1650074516062-c39941f36335?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=876&q=80`
...
box7.firstElementChild.setAttribute(`height`, `100%`)
box7.firstElementChild.setAttribute(`width`, `100%`)
...
inp.setAttribute(`placeholder`, `Enter your mail`)
